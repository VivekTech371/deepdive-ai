      ...
      <section ref={heroRef} className="relative min-h-[85vh] flex items-center overflow-hidden noise-overlay">
        ...
        <motion.div style={{ opacity: heroOpacity, y: heroY }} className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 py-20">
          <div className="max-w-2xl">
            ...
            >
              <span className="font-mono text-primary font-semibold">1,251 transcripts</span> growing every day. AI-powered search, multilingual support, and conference archives.
            </motion.p>
      ...
      <section className="border-y border-border bg-secondary/30">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <StatBlock icon={FileText} value="1,251" label="Transcripts" />
            <StatBlock icon={Users} value="100+" label="Speakers" />
            <StatBlock icon={Headphones} value="6" label="Conference Archives" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Bryan Bishop (@kanzure) manually transcribed ~900 transcripts over the years. Bitcoin Transcripts builds on this foundational work and is now maintained by the community with AI-powered tools.
            </p>
